    ...
    <div className={className}>
      <div className="w-full max-w-sm overflow-hidden rounded-2xl border border-slate-100 bg-white shadow-sm">
        <div className="flex items-center gap-3 border-b border-slate-50 px-5 py-3">
          <div className="grid h-7 w-7 place-items-center rounded-lg bg-ecotrace-50 text-xs font-bold text-ecotrace-800 ring-1 ring-inset ring-ecotrace-100">
            E
          </div>
        ...
        <div className="px-5 py-4">
          <label className="flex cursor-pointer items-start gap-3">
            <input
              ...
              className="mt-0.5 h-4 w-4 rounded border-slate-200 text-ecotrace-700 accent-ecotrace-700"
            />
