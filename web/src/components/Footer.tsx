        ...
        <div className="grid gap-10 lg:grid-cols-12">
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:col-span-3 lg:grid-cols-1">
            ...
            <div>
              ...
              <div className="mt-4 grid gap-2 text-sm">
                <a className="text-slate-600 hover:text-slate-950" href="#add-widget">
                  Book a demo
                </a>
                <a className="text-slate-600 hover:text-slate-950" href="#pricing">
                  ROI calculator
                </a>
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <form className="flex w-full max-w-md items-center gap-2">
              <input
                ...
                className="h-11 w-full rounded-xl border border-slate-200 bg-white px-3 text-sm text-slate-900 outline-none placeholder:text-slate-400 focus:border-ecotrace-400 focus:ring-4 focus:ring-ecotrace-100"
              />
              <button
                type="button"
                className="h-11 shrink-0 rounded-xl bg-ecotrace-700 px-4 text-sm font-semibold text-white transition duration-300 ease-out hover:-translate-y-0.5 hover:bg-ecotrace-800"
              >
                Join
              </button>
            </form>
