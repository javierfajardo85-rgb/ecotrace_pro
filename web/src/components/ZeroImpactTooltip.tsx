      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="z-[100] rounded-xl border border-slate-200 bg-white p-4 shadow-lg"
          >
            <div className="text-xs font-bold text-slate-950">{t("widget.zeroImpactTooltipTitle")}</div>
